  ...
  return (
    <div className="min-h-screen bg-white pt-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <Link to="/blog" className="text-emerald-600 hover:text-emerald-700 mb-8 inline-block">
          ← {lang === 'tr' ? 'Blog\'a Dön' : 'Back to Blog'}
        </Link>
        ...
        <div className="mb-4">
          <span className="text-sm text-emerald-600 font-semibold">{post.category[lang]}</span>
